...
public class InterfazAlcancia extends JFrame {
    ...
    public InterfazAlcancia() {
        ...
        // getContentPane() retrieves the content pane of the container, where components are typically added.
    ...
    public void reqFunc2() {
        ...
        if (alcancia.valiosa()) {
            ...
            resultado = "La alcancia no es valiosa, posee monedas de denominaciones diferentes a 1000 o de 500, o no " +
                    "posee denominaciones valiosas.";
        }
        JOptionPane.showMessageDialog(this,
                resultado,
                "Respuesta",
